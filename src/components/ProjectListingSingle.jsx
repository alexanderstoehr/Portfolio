export default function ProjectListingSingle({project, handleProjectClick}) {
    ...
    return (
        <>
            <div id={project.id}
                 className="flex flex-col md:h-full cursor-pointer rounded-2xl transition duration-300 hover:scale-105 z-0 shadow-md shadow-gray-400 hover:shadow-cyan-400 dark:hover:shadow-cyan-300 dark:shadow-white/10"
